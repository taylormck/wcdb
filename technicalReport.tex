...
\includegraphics*[width=4in,height=6in]{dataModelDiagram.png}
\newline
\footnotesize This is a diagram of our data model\normalsize % note under the picture
\newline\newline

Please don't be footnotesize
